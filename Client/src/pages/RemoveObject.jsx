...
import { Eraser, Hash, Scissors, Sparkle, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex flex-wrap gap-4 text-slate-700 items-start">
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]">
        ...
        {
          !content ? ( <div className="flex-1 flex-col flex justify-center items-center gap-5 text-gray-400">
